...
/*=============================================*/
    ...
    #define check(x) cout<<"Check Result : "<<x<<endl
...
/*===========================================================================================*/
    ...
    ll MinCandy,MinOrange;

    MinCandy = *min_element(candy.begin(),candy.end());
    MinOrange = *min_element(orange.begin(), orange.end());
    ...
    fr(i,n)
    {
        ...
        {
            sum+= candy[i]- MinCandy ;

        }
        else{
            sum+= orange[i]- MinOrange;
        }
