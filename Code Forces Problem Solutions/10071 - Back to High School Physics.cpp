...
/*===========================================================================================*/
    ...
    x = lower_bound(v.begin(),v.end(),n+1)-v.begin(); //index of the lower bound (n+1 cause n er ag porjonto cheak korbe)
    x = v[x-1]; //value of lower bound
