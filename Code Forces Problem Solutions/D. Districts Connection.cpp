...
/*=============================================*/
    ...
    #define LN __int128
    #define show(arr,n) for( ll i = 1;i<=n;i++ ) cout<<arr[i]<<" "
    #define input(arr,n) for( ll i = 1;i<=n;i++ ) cin>>arr[i]
    ...
    #define NoYoN_Variables ll n,a,b,c,x,y,z,i,j,k,sum=0,t=0,count=0,flag=-1; string s,s1,s2,s3; bool is = false; double Sum=0;
