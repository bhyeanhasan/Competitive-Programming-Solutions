...
/*===========================================================================================*/
    double bariH = 17*12;
    double bariW = 9*12;
    double bariArea = bariH * bariW ;
    double floorEit = 9.5*4.5;
    double sideEit = 4.5*2.75;
    double sideHeight = 2.5 * 12;

    cout<<"Floor Area in inch "<<bariArea<<endl;

    double floorNeed = bariArea/floorEit;

    cout<<"Floor Need eit"<<floorNeed<<endl;


    double side = (2*(bariH+bariW))* sideHeight;

    cout<<"Side Area "<<side<<endl;

    double sideNeed = side/ sideEit;

    cout<<"Side need "<<sideNeed<<endl;
